/*Info
    ...
    DESCRIPTION
		...
		Plan for Version 0.0.9 name all prints correctly ,get all mainsplits finished
...
startup {
	...
	settings.Add("speedrun", true,"Version 0.0.7 By WarsheepGER.");
...
//Items  
			if (settings["collectible"]){vars.collectible=1;vars.countcollect=0;vars.collect=1; print("Autosplitter| Split: X aktivated");}else{ vars.collectible=0;vars.countcollect=0;;vars.collect=0;}
			if (settings["wallet"]){vars.wallet=1;vars.wallet1=1;vars.wallet2=0;vars.wallet3=0;vars.wallet4=0;vars.wallet5=0;vars.wallet6=0;vars.wallet7=0;vars.wallet8=0;vars.wallet9=0;vars.wallet10=0; print("Autosplitter| Split: Wallet Upgrade aktivated");}else{ vars.wallet1=0;vars.wallet2=0;vars.wallet3=0;vars.wallet4=0;vars.wallet5=0;vars.wallet6=0;vars.wallet7=0;vars.wallet8=0;vars.wallet9=0;vars.wallet10=0;}
			if (settings["nugget"]){vars.nugget=1;vars.nugget1=1;vars.nugget2=0;vars.nugget3=0;vars.nugget4=0; print("Autosplitter| Split: Nuggets aktivated");}else{ vars.nugget=0;}
			
			if (settings["tadpole"]){vars.tadpole=1;vars.counttadpole=0;vars.tad=1; print("Autosplitter| Split: Tadpole aktivated");}else{ vars.tadpole=0;vars.counttadpole=0;vars.tad=0;}
			if (settings["dustbunny_dirty"]){vars.dustbunny_dirty=1;vars.countdustbunny=0;vars.dustbunny=1; print("Autosplitter| Split: X aktivated");}else{ vars.dustbunny_dirty=0;vars.countdustbunny=0;vars.dustbunny=0;}
			if (settings["traitor_spirit"]){vars.traitor_spirit=1;vars.counttraitor=0;vars.traitor=1; print("Autosplitter| Split: X aktivated");}else{ vars.traitor_spirit=0;vars.counttraitor_spirit=0;vars.traitor=0;}
			...
			if (settings["abilities/kickback2"]){vars.abilities_kickback2=1;vars.kickback2=0; print("Autosplitter| Split: Kickback 2 aktivated");}else{ vars.abilities_kickback2=0;vars.kickback2=0;}
