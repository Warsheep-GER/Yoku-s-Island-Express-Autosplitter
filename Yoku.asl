/*Info
    ...
    DESCRIPTION
		...
		Plan for Version 0.1 name all missed prints correctly ,get some mainsplits finished
...
startup {
	...
	settings.Add("speedrun", true,"Version 0.0.9 By WarsheepGER.");
...
////
	if(vars.jungle_canyon_caper==1 && current.LevelName.Equals("memscan_level\njungle_canyon_caper")){ print("Autosplitter| Split: jungle_canyon_caper");vars.jungle_canyon_caper=0;return true;}
	if(vars.jungle_crammed_canopy==1 && current.LevelName.Equals("memscan_level\njungle_crammed_canopy")){ print("Autosplitter| Split: jungle_crammed_canopy");vars.jungle_crammed_canopy=0;return true;}
	if(vars.jungle_misty_meadow==1 && current.LevelName.Equals("memscan_level\njungle_misty_meadow")){ print("Autosplitter| Split: jungle_misty_meadow");vars.jungle_misty_meadow=0;return true;}
	if(vars.jungle_mollusc_madness==1 && current.LevelName.Equals("memscan_level\njungle_mollusc_madness")){ print("Autosplitter| Split: jungle_mollusc_madness");vars.jungle_mollusc_madness=0;return true;}
	if(vars.jungle_roots==1 && current.LevelName.Equals("memscan_level\njungle_roots")){ print("Autosplitter| Split: jungle_roots");vars.jungle_roots=0;return true;}
	if(vars.jungle_secluded_climb==1 && current.LevelName.Equals("memscan_level\njungle_secluded_climb")){ print("Autosplitter| Split: jungle_secluded_climb");vars.jungle_secluded_climb=0;return true;}
	if(vars.jungle_slug_struggle==1 && current.LevelName.Equals("memscan_level\njungle_slug_struggle")){ print("Autosplitter| Split: jungle_slug_struggle");vars.jungle_slug_struggle=0;return true;}
	if(vars.jungle_spikey_stockade==1 && current.LevelName.Equals("memscan_level\njungle_spikey_stockade")){ print("Autosplitter| Split: jungle_spikey_stockade");vars.jungle_spikey_stockade=0;return true;}
	if(vars.jungle_tall_tall_tower==1 && current.LevelName.Equals("memscan_level\njungle_tall_tall_tower")){ print("Autosplitter| Split: jungle_tall_tall_tower");vars.jungle_tall_tall_tower=0;return true;}
	if(vars.jungle_willy==1 && current.LevelName.Equals("memscan_level\njungle_willy")){ print("Autosplitter| Split: jungle_willy");vars.jungle_willy=0;return true;}	
	if(vars.peak_aerial_ascent==1 && current.LevelName.Equals("memscan_level\npeak_aerial_ascent")){ print("Autosplitter| Split: peak_aerial_ascent");vars.peak_aerial_ascent=0;return true;}	
	if(vars.peak_beanstalk_base==1 && current.LevelName.Equals("memscan_level\npeak_beanstalk_base")){ print("Autosplitter| Split: peak_beanstalk_base");vars.peak_beanstalk_base=0;return true;}	
	if(vars.peak_crooked_cliff==1 && current.LevelName.Equals("memscan_level\npeak_crooked_cliff")){ print("Autosplitter| Split: peak_crooked_cliff");vars.peak_crooked_cliff=0;return true;}	
	if(vars.peak_crystal_crater==1 && current.LevelName.Equals("memscan_level\npeak_crystal_crater")){ print("Autosplitter| Split: peak_crystal_crater");vars.peak_crystal_crater=0;return true;}	
	if(vars.peak_filthy_flat==1 && current.LevelName.Equals("memscan_level\npeak_filthy_flat")){ print("Autosplitter| Split: peak_filthy_flat");vars.peak_filthy_flat=0;return true;}	
	if(vars.peak_frostpine_forest==1 && current.LevelName.Equals("memscan_level\npeak_frostpine_forest")){ print("Autosplitter| Split: peak_frostpine_forest");vars.peak_frostpine_forest=0;return true;}	
	if(vars.peak_guano_grief==1 && current.LevelName.Equals("memscan_level\npeak_guano_grief")){ print("Autosplitter| Split: peak_guano_grief");vars.peak_guano_grief=0;return true;}	
	if(vars.peak_ice_cold_idol==1 && current.LevelName.Equals("memscan_level\npeak_ice_cold_idol")){ print("Autosplitter| Split: peak_ice_cold_idol");vars.peak_ice_cold_idol=0;return true;}	
	if(vars.peak_obtainium_oracle==1 && current.LevelName.Equals("memscan_level\npeak_obtainium_oracle")){ print("Autosplitter| Split: peak_obtainium_oracle");vars.peak_obtainium_oracle=0;return true;}	
	if(vars.peak_sky==1 && current.LevelName.Equals("memscan_level\npeak_sky")){ print("Autosplitter| Split: peak_sky");vars.peak_sky=0;return true;}	
	if(vars.peak_spacemonk_mystery==1 && current.LevelName.Equals("memscan_level\npeak_spacemonk_mystery")){ print("Autosplitter| Split: peak_spacemonk_mystery");vars.peak_spacemonk_mystery=0;return true;}	
	if(vars.peak_spider_fight==1 && current.LevelName.Equals("memscan_level\npeak_spider_fight")){ print("Autosplitter| Split: peak_spider_fight");vars.peak_spider_fight=0;return true;}	
	if(vars.peak_underside==1 && current.LevelName.Equals("memscan_level\npeak_underside")){ print("Autosplitter| Split: peak_underside");vars.peak_underside=0;return true;}	
	if(vars.spring_bubbly_basin==1 && current.LevelName.Equals("memscan_level\nspring_bubbly_basin")){ print("Autosplitter| Split: spring_bubbly_basin");vars.spring_bubbly_basin=0;return true;}	
	if(vars.spring_cloudburst_cliffs==1 && current.LevelName.Equals("memscan_level\nspring_cloudburst_cliffs")){ print("Autosplitter| Split: spring_cloudburst_cliffs");vars.spring_cloudburst_cliffs=0;return true;}	
	if(vars.spring_gangway_grotto==1 && current.LevelName.Equals("memscan_level\nspring_gangway_grotto")){ print("Autosplitter| Split: spring_gangway_grotto");vars.spring_gangway_grotto=0;return true;}	
	if(vars.spring_hazy_heaven==1 && current.LevelName.Equals("memscan_level\nspring_hazy_heaven")){ print("Autosplitter| Split: spring_hazy_heaven");vars.spring_hazy_heaven=0;return true;}	
	if(vars.spring_hidden_hotspring==1 && current.LevelName.Equals("memscan_level\nspring_hidden_hotspring")){ print("Autosplitter| Split: spring_hidden_hotspring");vars.spring_hidden_hotspring=0;return true;}	
	if(vars.spring_jailhouse_japes==1 && current.LevelName.Equals("memscan_level\nspring_jailhouse_japes")){ print("Autosplitter| Split: spring_jailhouse_japes");vars.spring_jailhouse_japes=0;return true;}	
	if(vars.spring_shoddy_shanty==1 && current.LevelName.Equals("memscan_level\nspring_shoddy_shanty")){ print("Autosplitter| Split: spring_shoddy_shanty");vars.spring_shoddy_shanty=0;return true;}	
	if(vars.spring_sleek_slabs==1 && current.LevelName.Equals("memscan_level\nspring_sleek_slabs")){ print("Autosplitter| Split: spring_sleek_slabs");vars.spring_sleek_slabs=0;return true;}	
	if(vars.spring_tiny_broad==1 && current.LevelName.Equals("memscan_level\nspring_tiny_broad")){ print("Autosplitter| Split: spring_tiny_broad");vars.spring_tiny_broad=0;return true;}	
	if(vars.spring_tortoise_tunnel==1 && current.LevelName.Equals("memscan_level\nspring_tortoise_tunnel")){ print("Autosplitter| Split: spring_tortoise_tunnel");vars.spring_tortoise_tunnel=0;return true;}	
	if(vars.spring_yokos_yam==1 && current.LevelName.Equals("memscan_level\nspring_yokos_yam")){ print("Autosplitter| Split: spring_yokos_yam");vars.spring_yokos_yam=0;return true;}
	}
//Items 
	...
	if(vars.nugget==1){if(vars.nugget1==1 && current.GameItem.Equals("memscan_last_item_added\nnugget:1")){print("Autosplitter| Split: Nugged 1");vars.nugget1=0;vars.nugget2=1;return true;}if(vars.nugget2==1 && current.GameItem.Equals("memscan_last_item_added\nnugget:2")){print("Autosplitter| Split: Nugged 2");vars.nugget2=0;vars.nugget3=1;return true;}if(vars.nugget3==1 && current.GameItem.Equals("memscan_last_item_added\nnugget:3")){print("Autosplitter| Split: Nugged 3");vars.nugget3=0;vars.nugget4=1;return true;}if(vars.nugget4==1 && current.GameItem.Equals("memscan_last_item_added\nnugget:4")){print("Autosplitter| Split: Nugget 4");vars.nugget4=0;vars.nugget=0;return true;}}	
	...
	if(vars.abilities_kickback2==1 && current.GameItem.Equals("memscan_last_item_removed\nabilities/kickback:1")){vars.abilities_kickback2=0;vars.kickback2=1;}if(vars.kickback2==1 && current.GameItem.Equals("memscan_last_item_added\nabilities/kickback:1")){print("Autosplitter| Split: Kickback 2");vars.kickback2=0;return true;}	
	if(vars.abilities_dive==1 && current.GameItem.Equals("memscan_last_item_added\nabilities/dive:1")){ print("Autosplitter| Split: abilities_dive");vars.abilities_dive=0;return true;}
	if(vars.abilities_dive_speed==1 && current.GameItem.Equals("memscan_last_item_added\nabilities/dive_speed:1")){ print("Autosplitter| Split: abilities_dive_speed");vars.abilities_dive_speed=0;return true;}
	if(vars.abilities_hook==1 && current.GameItem.Equals("memscan_last_item_added\nabilities/hook:1")){ print("Autosplitter| Split: abilities_hook");vars.abilities_hook=0;return true;}
	if(vars.sootling_leash==1 && current.GameItem.Equals("memscan_last_item_added\nsootling_leash:1")){ print("Autosplitter| Split: sootling_leash");vars.sootling_leash=0;return true;}
	if(vars.bucket_empty==1 && current.GameItem.Equals("memscan_last_item_added\nbucket_empty:1")){ print("Autosplitter| Split: bucket_empty");vars.bucket_empty=0;return true;}
	if(vars.bucket_full==1 && current.GameItem.Equals("memscan_last_item_added\nbucket_full:1")){ print("Autosplitter| Split: bucket_full");vars.bucket_full=0;return true;}
	...
	if(vars.seed_pod==1 && current.GameItem.Equals("memscan_last_item_added\nseed_pod:1")){ print("Autosplitter| Split: seed_pod");vars.seed_pod=0;return true;}
	if(vars.bluekey==1 && current.GameItem.Equals("memscan_last_item_added\nbluekey:1")){ print("Autosplitter| Split: bluekey");vars.bluekey=0;return true;}
	if(vars.greenkey==1 && current.GameItem.Equals("memscan_last_item_added\ngreenkey:1")){ print("Autosplitter| Split: greenkey");vars.greenkey=0;return true;}
	if(vars.spring_key==1 && current.GameItem.Equals("memscan_last_item_added\nspring_key:1")){ print("Autosplitter| Split: spring_key");vars.spring_key=0;return true;}
	if(vars.nim_key==1 && current.GameItem.Equals("memscan_last_item_added\nnim_key:1")){ print("Autosplitter| Split: nim_key");vars.nim_key=0;return true;}
	if(vars.instrument_pile==1 && current.GameItem.Equals("memscan_last_item_added\ninstrument_pile:1")){ print("Autosplitter| Split: instrument_pile");vars.instrument_pile=0;return true;}
	...
	if(vars.sad_spider==1 && current.GameItem.Equals("memscan_last_item_added\nsad_spider:1")){ print("Autosplitter| Split: sad_spider");vars.sad_spider=0;return true;}
	if(vars.postal_badge==1 && current.GameItem.Equals("memscan_last_item_added\npostal_badge:1")){ print("Autosplitter| Split: postal_badge");vars.postal_badge=0;return true;}
	if(vars.treasure_map==1 && current.GameItem.Equals("memscan_last_item_added\ntreasure_map:1")){ print("Autosplitter| Split: treasure_map");vars.treasure_map=0;return true;}
	if(vars.mushroom_2==1 && current.GameItem.Equals("memscan_last_item_added\nmushroom_2:1")){ print("Autosplitter| Split: mushroom_2");vars.mushroom_2=0;return true;}
	if(vars.mushroom_3==1 && current.GameItem.Equals("memscan_last_item_added\nmushroom_3:1")){ print("Autosplitter| Split: mushroom_3");vars.mushroom_3=0;return true;}
	if(vars.powerups_skvader_1==1 && current.GameItem.Equals("memscan_last_item_added\npowerups/skvader_1:1")){ print("Autosplitter| Split: powerups_skvader_1");vars.powerups_skvader_1=0;return true;}
	if(vars.powerups_skvader_2==1 && current.GameItem.Equals("memscan_last_item_added\npowerups/skvader_2:1")){ print("Autosplitter| Split: powerups_skvader_2");vars.powerups_skvader_2=0;return true;}
	if(vars.package_3==1 && current.GameItem.Equals("memscan_last_item_added\npackage_3:1")){ print("Autosplitter| Split: package_3");vars.package_3=0;return true;}
	if(vars.package_2==1 && current.GameItem.Equals("memscan_last_item_added\npackage_2:1")){ print("Autosplitter| Split: package_2");vars.package_2=0;return true;}
	if(vars.package_1==1 && current.GameItem.Equals("memscan_last_item_added\npackage_1:1")){ print("Autosplitter| Split: package_1");vars.package_1=0;return true;}
	if(vars.idol1==1 && current.GameItem.Equals("memscan_last_item_added\nidol1:1")){ print("Autosplitter| Split: idol1");vars.idol1=0;return true;}
	if(vars.idol2==1 && current.GameItem.Equals("memscan_last_item_added\nidol2:1")){ print("Autosplitter| Split: idol2");vars.idol2=0;return true;}
	if(vars.idol3==1 && current.GameItem.Equals("memscan_last_item_added\nidol3:1")){ print("Autosplitter| Split: idol3");vars.idol3=0;return true;}
	if(vars.idol4==1 && current.GameItem.Equals("memscan_last_item_added\nidol4:1")){ print("Autosplitter| Split: idol4");vars.idol4=0;return true;}
	if(vars.spores_1==1 && current.GameItem.Equals("memscan_last_item_added\nspores_1:1")){ print("Autosplitter| Split: spores_1");vars.spores_1=0;return true;}
	if(vars.spores_2==1 && current.GameItem.Equals("memscan_last_item_added\nspores_2:1")){ print("Autosplitter| Split: spores_2");vars.spores_2=0;return true;}
	if(vars.spores_3==1 && current.GameItem.Equals("memscan_last_item_added\nspores_3:1")){ print("Autosplitter| Split: spores_3");vars.spores_3=0;return true;}
	if(vars.spores_4==1 && current.GameItem.Equals("memscan_last_item_added\nspores_4:1")){ print("Autosplitter| Split: spores_4");vars.spores_4=0;return true;}
	if(vars.spores_5==1 && current.GameItem.Equals("memscan_last_item_added\nspores_5:1")){ print("Autosplitter| Split: spores_5");vars.spores_5=0;return true;}
	if(vars.tracker_caves==1 && current.GameItem.Equals("memscan_last_item_added\ntracker_caves:1")){ print("Autosplitter| Split: tracker_caves");vars.tracker_caves=0;return true;}
	if(vars.tracker_jungle==1 && current.GameItem.Equals("memscan_last_item_added\ntracker_jungle:1")){ print("Autosplitter| Split: tracker_jungle");vars.tracker_jungle=0;return true;}
	if(vars.tracker_peak==1 && current.GameItem.Equals("memscan_last_item_added\ntracker_peak:1")){ print("Autosplitter| Split: tracker_peak");vars.tracker_peak=0;return true;}
	if(vars.tracker_springs==1 && current.GameItem.Equals("memscan_last_item_added\ntracker_springs:1")){ print("Autosplitter| Split: tracker_springs");vars.tracker_springs=0;return true;}
	if(vars.tracker_scarabs==1 && current.GameItem.Equals("memscan_last_item_added\ntracker_scarabs:1")){ print("Autosplitter| Split: tracker_scarabs");vars.tracker_scarabs=0;return true;}
	if(vars.skins_skin_1==1 && current.GameItem.Equals("memscan_last_item_added\nskins/skin_1:1")){ print("Autosplitter| Split: skins_skin_1");vars.skins_skin_1=0;return true;}
	if(vars.skins_skin_2==1 && current.GameItem.Equals("memscan_last_item_added\nskins/skin_2:1")){ print("Autosplitter| Split: skins_skin_2");vars.skins_skin_2=0;return true;}
	if(vars.skins_skin_3==1 && current.GameItem.Equals("memscan_last_item_added\nskins/skin_3:1")){ print("Autosplitter| Split: skins_skin_3");vars.skins_skin_3=0;return true;}
	if(vars.skins_skin_4==1 && current.GameItem.Equals("memscan_last_item_added\nskins/skin_4:1")){ print("Autosplitter| Split: skins_skin_4");vars.skins_skin_4=0;return true;}
	if(vars.skins_skin_5==1 && current.GameItem.Equals("memscan_last_item_added\nskins/skin_5:1")){ print("Autosplitter| Split: skins_skin_5");vars.skins_skin_5=0;return true;}
	}
//State
...
//Levels
			...
			if (settings["hub_left_lofty_logo"] || settings["any%true"]){vars.hub_left_lofty_logo=1; print("Autosplitter| Aktiv: Titel Screen [H8]");}else{ vars.hub_left_lofty_logo=0;}
			...
			if (settings["island_ending_2"]){vars.island_ending_2=1; print("Autosplitter| Aktiv: True End [I7]");}else{ vars.island_ending_2=0;}							
...
//Items  
			...
			if (settings["wallet"]){vars.wallet=1;vars.wallet1=1;vars.wallet2=0;vars.wallet3=0;vars.wallet4=0;vars.wallet5=0;vars.wallet6=0;vars.wallet7=0;vars.wallet8=0;vars.wallet9=0;vars.wallet10=0; print("Autosplitter| Aktiv: Wallet Upgrade");}else{ vars.wallet1=0;vars.wallet2=0;vars.wallet3=0;vars.wallet4=0;vars.wallet5=0;vars.wallet6=0;vars.wallet7=0;vars.wallet8=0;vars.wallet9=0;vars.wallet10=0;}
			...
			if (settings["summons"]){vars.summons=1; print("Autosplitter| Aktiv: Summons");}else{ vars.summons=0;}
			if (settings["abilities/map"]){vars.abilities_map=1; print("Autosplitter| Aktiv: Map");}else{ vars.abilities_map=0;}
			if (settings["abilities/partyhorn"] || settings["any%true"]){vars.abilities_partyhorn=1; print("Autosplitter| Aktiv: Noismaker");}else{ vars.abilities_partyhorn=0;}
			if (settings["abilities/mailbag"]){vars.abilities_mailbag=1; print("Autosplitter| Aktiv: Mail bag");}else{ vars.abilities_mailbag=0;}
			if (settings["abilities/speed"]){vars.abilities_speed=1; print("Autosplitter| Aktiv: Grand Postmaster Badge");}else{ vars.abilities_speed=0;}
			if (settings["abilities/double_fruit"]){vars.abilities_double_fruit=1; print("Autosplitter| Aktiv: Boon of Plenty!");}else{ vars.abilities_double_fruit=0;}
			if (settings["abilities/slug_vaccum"]){vars.abilities_slug_vaccum=1; print("Autosplitter| Aktiv: Slug Vacuum");}else{ vars.abilities_slug_vaccum=0;}
			if (settings["abilities/slug_upgrade"]){vars.abilities_slug_upgrade=1; print("Autosplitter| Aktiv: Slug Vacuum Deluxe");}else{ vars.abilities_slug_upgrade=0;}
			if (settings["abilities/kickback"]){vars.abilities_kickback=1; print("Autosplitter| Aktiv: Kickback");}else{ vars.abilities_kickback=0;}
			if (settings["abilities/kickback2"]){vars.abilities_kickback2=1;vars.kickback2=0; print("Autosplitter| Aktiv: Kickback 2");}else{ vars.abilities_kickback2=0;vars.kickback2=0;}
			if (settings["abilities/dive"]){vars.abilities_dive=1; print("Autosplitter| Aktiv: Dive Fish");}else{ vars.abilities_dive=0;}
			if (settings["abilities/dive_speed"]){vars.abilities_dive_speed=1; print("Autosplitter| Aktiv: Fast Dive Fish");}else{ vars.abilities_dive_speed=0;}
			if (settings["abilities/hook"]){vars.abilities_hook=1; print("Autosplitter| Aktiv: Sootling on a Leash");}else{ vars.abilities_hook=0;}
			if (settings["sootling_leash"]){vars.sootling_leash=1; print("Autosplitter| Aktiv: Sootling Leash");}else{ vars.sootling_leash=0;}
			if (settings["bucket_empty"]){vars.bucket_empty=1; print("Autosplitter| Aktiv: Empty Bucket");}else{ vars.bucket_empty=0;}
			if (settings["bucket_full"]){vars.bucket_full=1; print("Autosplitter| Aktiv: Bucket of Spring Water");}else{ vars.bucket_full=0;}
			if (settings["guano"]){vars.guano=1; print("Autosplitter| Aktiv: Guano");}else{ vars.guano=0;}
			if (settings["seed_pod"]){vars.seed_pod=1; print("Autosplitter| Aktiv: Seed Pod");}else{ vars.seed_pod=0;}
			if (settings["bluekey"]){vars.bluekey=1; print("Autosplitter| Aktiv: Blue Key");}else{ vars.bluekey=0;}
			if (settings["greenkey"]){vars.greenkey=1; print("Autosplitter| Aktiv: Green Key");}else{ vars.greenkey=0;}
			if (settings["spring_key"]){vars.spring_key=1; print("Autosplitter| Aktiv: Key to the Underbelly");}else{ vars.spring_key=0;}
			if (settings["nim_key"]){vars.nim_key=1; print("Autosplitter| Aktiv: Nims Key");}else{ vars.nim_key=0;}
			if (settings["instrument_pile"]){vars.instrument_pile=1; print("Autosplitter| Aktiv: Ceremony Instruments");}else{ vars.instrument_pile=0;}
			...
			if (settings["powerups/skvader_2"]){vars.powerups_skvader_2=1; print("Autosplitter| Aktiv: Fat Skvader");}else{ vars.powerups_skvader_2=0;}
			if (settings["package_3"]){vars.package_3=1; print("Autosplitter| Aktiv: Overdue Package for Quinbe");}else{ vars.package_3=0;}
			if (settings["package_2"]){vars.package_2=1; print("Autosplitter| Aktiv: Overdue Package for Sin");}else{ vars.package_2=0;}
			if (settings["package_1"]){vars.package_1=1; print("Autosplitter| Aktiv: Overdue Package for Treek");}else{ vars.package_1=0;}
			if (settings["idol1"]){vars.idol1=1; print("Autosplitter| Aktiv: Statue Chunk");}else{ vars.idol1=0;}
			if (settings["idol2"]){vars.idol2=1; print("Autosplitter| Aktiv: Statue Piece 1");}else{ vars.idol2=0;}
			if (settings["idol3"]){vars.idol3=1; print("Autosplitter| Aktiv: Statue Piece 2");}else{ vars.idol3=0;}
			if (settings["idol4"]){vars.idol4=1; print("Autosplitter| Aktiv: Statue Piece 3");}else{ vars.idol4=0;}
			if (settings["spores_1"]){vars.spores_1=1; print("Autosplitter| Aktiv: Light Spores");}else{ vars.spores_1=0;}
			if (settings["spores_2"]){vars.spores_2=1; print("Autosplitter| Aktiv: Dry Spores");}else{ vars.spores_2=0;}
			if (settings["spores_3"]){vars.spores_3=1; print("Autosplitter| Aktiv: Damp Spores");}else{ vars.spores_3=0;}
			if (settings["spores_4"]){vars.spores_4=1; print("Autosplitter| Aktiv: Annoyed Spores");}else{ vars.spores_4=0;}
			if (settings["spores_5"]){vars.spores_5=1; print("Autosplitter| Aktiv: Frosty Spores");}else{ vars.spores_5=0;}
			if (settings["tracker_caves"]){vars.tracker_caves=1; print("Autosplitter| Aktiv: Cave Tracker");}else{ vars.tracker_caves=0;}
			if (settings["tracker_jungle"]){vars.tracker_jungle=1; print("Autosplitter| Aktiv: Jungle Tracker");}else{ vars.tracker_jungle=0;}
			if (settings["tracker_peak"]){vars.tracker_peak=1; print("Autosplitter| Aktiv: Peak Tracker");}else{ vars.tracker_peak=0;}
			if (settings["tracker_springs"]){vars.tracker_springs=1; print("Autosplitter| Aktiv: Springs Tracker");}else{ vars.tracker_springs=0;}
			...
			if (settings["skins/skin_2"]){vars.skins_skin_2=1; print("Autosplitter| Aktiv: Creepy Sprinkles");}else{ vars.skins_skin_2=0;}
			...
			if (settings["skins/skin_5"]){vars.skins_skin_5=1; print("Autosplitter| Aktiv: Sweet Sprinkles");}else{ vars.skins_skin_5=0;}
//State
			if (settings["doorintr"] || settings["any%true"]){vars.doorintr=1; print("Autosplitter| Aktiv: Door Introduction"); }else{ vars.doorintr=0;}
			if (settings["endbossdead"] || settings["any%true"]){vars.endbossdead=1; print("Autosplitter| Aktiv: Endboss dead"); }else{ vars.endbossdead=0;}
			if (settings["fruit100"]){vars.fruit100=1; print("Autosplitter| Aktiv: Fruit 100"); }else{ vars.fruit100=0;}
			if (settings["fruit600"]){vars.fruit600=1; print("Autosplitter| Aktiv: Fruit 600"); }else{ vars.fruit600=0;}
